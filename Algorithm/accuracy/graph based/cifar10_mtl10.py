...
def get_model():
    ...
    dense_3_3 = Dense(2, activation="softmax", name='dense_3_3')(dense_2_3_2)

    dense_3_2 = Dense(2, activation="softmax", name='dense_3_2')(dense_2_4_2)
...
save_path = './checkpoint/cifar10/'
dim_x, dim_y, dim_z = 32, 32, 3 # dimension for corresponding dataset
...
model = tf.keras.models.load_model('./checkpoint/cifar10/acc1_0.7401')
# model = get_model()
