...
def dataload_dataset(chosenType=-1):
    ...
    (x_train, y_train), (x_test, y_test) = keras.datasets.mnist.load_data()  # please use corresponding dataset
...
def get_model():
    ...
    conv_2_1 = Conv2D(48, kernel_size=(3, 3), activation="relu", name='conv_2_1')(pool_1_1)
    ...
    conv_2_2 = Conv2D(48, kernel_size=(3, 3), activation="relu", name='conv_2_2')(pool_1_2)
    ...
    conv_2_3 = Conv2D(48, kernel_size=(3, 3), activation="relu", name='conv_2_3')(pool_1_2)
    ...
    conv_2_4 = Conv2D(48, kernel_size=(3, 3), activation="relu", name='conv_2_4')(pool_1_3)
    ...
    dense_3_4 = Dense(2, activation="softmax", name='dense_3_4')(dense_2_3_2)

    dense_3_7 = Dense(2, activation="softmax", name='dense_3_7')(dense_2_4_2)
